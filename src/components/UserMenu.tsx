        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute right-0 mt-2 w-56 bg-white dark:bg-[#0f172a] p-2 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] z-50 border border-black/5 dark:border-white/10"
            >
