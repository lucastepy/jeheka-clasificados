        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute right-0 mt-2 w-56 bg-[var(--card-bg)] p-2 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.4)] z-50 border border-[var(--card-border)] backdrop-blur-3xl"
            >
