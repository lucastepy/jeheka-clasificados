...
export function UserMenu({ user }: UserMenuProps) {
  ...
  return (
    <div className="relative">
      ...
      >
        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-emerald-500 to-green-600 flex items-center justify-center text-white font-black text-xs shadow-lg shadow-emerald-500/20">
          {user.name.charAt(0).toUpperCase()}
        </div>
        <div className="flex flex-col items-start">
          <span className="text-[10px] font-black tracking-widest uppercase opacity-40">Portal</span>
          ...
          <>
            ...
            >
              <div className="px-4 py-3 border-b border-black/5 dark:border-white/5 mb-2">
                <p className="text-[9px] font-black opacity-30 uppercase tracking-[0.2em] mb-1">Tu Cuenta</p>
